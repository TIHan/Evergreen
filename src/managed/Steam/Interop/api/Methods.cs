...
public static unsafe partial class Methods
{
    ...
    [DllImport("Evergreen.Steam.Native.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern EgSteamNetworking_ListenSocket egSteamNetworking_CreateListenSocketIP([NativeTypeName("EgSteamNetworking_CreateListenSocketOptions &")] EgSteamNetworking_CreateListenSocketOptions* options);

    [DllImport("Evergreen.Steam.Native.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern EgSteamNetworking_ListenSocket egSteamNetworking_CreateListenSocketP2P([NativeTypeName("EgSteamNetworking_CreateListenSocketOptions &")] EgSteamNetworking_CreateListenSocketOptions* options);
    ...
    [DllImport("Evergreen.Steam.Native.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern EgSteamNetworking_Connection egSteamNetworking_ConnectIP([NativeTypeName("EgSteamNetworking_ConnectOptions &")] EgSteamNetworking_ConnectOptions* options);

    [DllImport("Evergreen.Steam.Native.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern EgSteamNetworking_Connection egSteamNetworking_ConnectP2P([NativeTypeName("EgSteamNetworking_ConnectOptions &")] EgSteamNetworking_ConnectOptions* options);
